...
import 'package:senior_citizen_app/screens/trackers/tracker_home.dart';
import 'package:senior_citizen_app/screens/video_call/video_call.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:senior_citizen_app/widgets/home_screen_widgets.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  checkRequiredPermission() async {
    ...
    if (!(permissionEnabled && serviceEnabled)) {
      ...
      if (cameraPermission == PermissionManager.PermissionStatus.granted &&
        ...
        // .checkServiceStatus(PermissionManager.PermissionGroup.microphone);
  ...
  Future checkLocationPermission() async {
    permission = await PermissionManager.Permission.location.status;
    // .checkPermissionStatus(PermissionManager.PermissionGroup.location);
    PermissionManager.ServiceStatus serviceStatus =
        await PermissionManager.Permission.location.serviceStatus;
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        content:
                                            Text('Initial setup not complete '),
